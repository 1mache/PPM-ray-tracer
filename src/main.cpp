...
{
	auto greenishAlbedo = Vec3(0.0f, 0.6f, 0.4f);
	...
	auto fuzzyMetal    =    std::make_shared<Metal>(metalAlbedo, 0.2f);
    ...
    Camera camera = Camera(
		screenDimensions,
		{ 0.2f, 0.0f, 1.0f }, // position
		{ 0.2f, 0.0f, -1.0f }, // direction
		M_PI / 1.8f ); // vertical field of view		
